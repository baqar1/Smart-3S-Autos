        ...
        @if (!$spareImages->isEmpty())
            @foreach ($spareImages as $image )
                <div class="dz-preview dz-processing dz-image-preview dz-complete">  
                    <div class="dz-image">
                        <img data-dz-thumbnail="" alt="user.png" src="{{asset('images/')}}/{{$image->filename}}">
                    </div>  
                    <div class="dz-details">    
                        <div class="dz-size"><span data-dz-size="">
                            <strong>2.3</strong> KB</span></div>   
                            <div class="dz-filename"><span data-dz-name="">{{$image->filename}}</span></div>  
                            </div>  <div class="dz-progress">
                                <span class="dz-upload" data-dz-uploadprogress="" style="width: 100%;"></span></div> 
