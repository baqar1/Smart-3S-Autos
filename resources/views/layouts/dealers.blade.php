                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li>
                        ...
                        <ul @if(\Request::route()->getName() == 'dealers.spare.parts.list' || \Request::route()->getName() == 'dealers.spare.parts.view') class="collapse in" aria-expanded="true" @endif>
                            ...
                            <li @if(\Request::route()->getName() == 'dealers.spare.parts.view') class="active" @endif><a href="{{route('dealers.spare.parts.view')}}">Add New SparePart</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul @if(\Request::route()->getName() == 'dealers.service.list' || \Request::route()->getName() == 'dealers.service.view') class="collapse in" aria-expanded="true" @endif>
                            <li @if(\Request::route()->getName() == 'dealers.service.list') class="active" @endif><a href="{{route('dealers.service.list')}}">Service List</a></li>
                            <li @if(\Request::route()->getName() == 'dealers.service.view') class="active" @endif><a href="{{route('dealers.service.view')}}">Add New Service</a></li>
                        </ul>
                    </li>
